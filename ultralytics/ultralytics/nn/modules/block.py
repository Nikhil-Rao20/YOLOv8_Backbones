...
__all__ = ('DFL', 'HGBlock', 'HGStem', 'SPP', 'SPPF', 'C1', 'C2', 'C3', 'C2f', 'C3x', 'C3TR', 'C3Ghost',
           'GhostBottleneck', 'Bottleneck', 'BottleneckCSP', 'Proto', 'RepC3','BasicBlock_Res', 'ResNetBlock')
...
class ResNetBlock(nn.Module):
    def __init__(self, c1, c2, n=3, shortcut=False, block_type="basic", stride=1):
        ...
        for i in range(n):
            ...
            self.blocks.append(
                BasicBlock_Res(c1 if i == 0 else c2, c2, stride=stride_i)
            )
